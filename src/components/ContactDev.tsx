  ...
  return (
    <div className="py-6 h-full">
      ...
      <div className="flex flex-col justify-evenl items-center w-full h-5/6 my-3 px-8 gap-2">
        ...
        <textarea rows={5} className="w-full h-3/6 border-2 border-primary rounded-lg py-2 px-3 bg-transparent placeholder:text-black" value={form.message} onChange={handleChange} name="message" id="name" placeholder="Your Message"/>
